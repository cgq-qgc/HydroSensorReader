...
# Form implementation generated from reading ui file 'U:\Programmation\HydroHackOp\gui\pyqt_ui\om\specimen_entry.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.stackWidget_specimens = QtGui.QTabWidget(Form)
        ...
        self.stackWidget_specimens.setAutoFillBackground(False)
        self.stackWidget_specimens.setMovable(True)
